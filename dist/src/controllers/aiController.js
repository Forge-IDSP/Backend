...
const aiServices_1 = require("../controllers/aiServices");
const myPathwayService_1 = require("../controllers/myPathwayService");
class AiController {
...
exports.aiController = new AiController(aiServices_1.aiService);
