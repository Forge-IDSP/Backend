...
import { integer, pgTable, serial, timestamp, unique, varchar, primaryKey, jsonb, text } from "drizzle-orm/pg-core";
...
export const myPathwayBadges = pgTable("my_pathway_badges", {
...
export const myPathwayBadgesRelations = relations(myPathwayBadges, ({ one }) => ({
