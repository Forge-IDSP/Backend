...
async function runTests() {
    ...
    try {
        const result = await aiService.checkNextPoint("Yes, I'm ready!", "Are you ready to move on to the apprenticeship stage?");
    ...
    try {
        const result = await aiService.checkNextPoint("What tools do electricians use?", "Electricians use various tools like multimeters and wire strippers.");
        console.log("✅ Result:", result);
    ...
    try {
        const result = await aiService.checkNextPoint("Not yet, I have more questions", "Should we continue to the next stage?");
        console.log("✅ Result:", result);
        console.assert(result.isProgressionQuestion === true, "Should detect progression question");
    ...
    try {
        const result = await aiService.checkNextPoint("Maybe... I think so?", "Are you ready to advance to the next level?");
